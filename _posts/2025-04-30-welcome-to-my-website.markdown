...
Check out the [About section][aboutme] on the homepage if you want to know more about my interests, or go to the [CV][curriculum] page if you want more details about my career. I also have a [Linkedin account][linkedin] and a [GitHub account][github] if you want to check it out!

[ntnu]: https://www.ntnu.edu/
[curriculum]: {{ site.baseurl }}/curriculum/
[aboutme]: {{ site.baseurl }}/#about
