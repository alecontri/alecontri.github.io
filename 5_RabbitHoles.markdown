...
<div class="card-grid">
  ...
  <a class="project-card" href="{{ "/rabbit-holes/three-body-problem/" | relative_url }}">
    ...
    <div class="project-card__body">
      <h3>A restricted fiction</h3>
      <p>The three body problem: the origin of chaos and how to get a handle on it.</p>
  ...
  <a class="project-card" href="{{ "/rabbit-holes/gravitational-waves/" | relative_url }}">
    <div class="project-card__media project-card__media--single">
    ...
    <div class="project-card__body">
      ...
      <p>Numerical relativity: how to birdwatch for a cosmic ballet.</p>
      <div class="project-card__tags">
  ...
  <a class="project-card" href="{{ "/rabbit-holes/willmore-flow/" | relative_url }}">
    <div class="project-card__media project-card__media--single">
    ...
    <div class="project-card__body">
      ...
      <p>Fluid deformable membranes: the two-faced nature of eukaryotic cells.</p>
      <div class="project-card__tags">
